...
import { StepWiseInstructionFunctionality } from 'src/app/core/abstract/StepwiseInstructionFunctionality';
...
export class AboutComponent
  extends StepWiseInstructionFunctionality
  implements OnInit
{
  ...
  images = [
    {
      ...
      description:
        'I am a fullstack web developer. I love to spend time learning new technologies.',
    },
    {
      id: 'watchb',
      show: false,
      ...
      description:
        'This page is developed using angular. Angular material is used for styling.',
    },
    {
      id: 'watchc',
      show: false,
      ...
      description:
        'spring boot starter dependencies are awesome for quick development of websites.',
    },
    {
      id: 'watchd',
      show: false,
  ...
  override next(index:number):StepWiseInstruction{
    const instruction = super.next(index);
    this.cdr.detectChanges();
    if(instruction && instruction.show){
      const el = document.getElementById(instruction.id);
